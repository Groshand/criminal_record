...
@section('cout')
    ...
    <div class="container ">
        <div class="container row ">
            <button type="button" class="btn btn-info col-md-4 border border-light btn-lg" data-toggle="modal" data-target="#myModal1">Your consider Offenses</button>
            <button type="button" class="btn btn-info col-md-4 border border-light btn-lg" data-toggle="modal" data-target="#myModal2">You Accepted Offenses</button>
            <button type="button" class="btn btn-info col-md-4 border border-light btn-lg" data-toggle="modal" data-target="#myModal3">You Rejected Offenses</button>
        </div>
        ...
        <div class="row container my-4 border border-light py-3 rounded">
            <div class="col-md-8">
                @if($user)
